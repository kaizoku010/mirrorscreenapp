...
import { db, collection, onSnapshot, doc,setDoc , updateDoc, ref, uploadBytes, getDownloadURL, storage } from '../operations/firebase'; // Adjust firebase imports as per your setup
...
function Valuser() {
  ...
  const handleSave = async () => {
    if (editedUser.id) {
      ...
      conso le.warn('No ID found in editedUser:', editedUser);
    }
  };
