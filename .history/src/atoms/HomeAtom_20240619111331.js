    ...
    <>
      ...
      >
        <Box sx={modalStyle}>
          ...
          <button className='no-id2' onClick={handleModalClose} variant="contained" sx={{ mt: 2 }}>Visit Our Website </button>
          <button className='no-id' onClick={handleModalClose} variant="contained" sx={{ mt: 2 }}>B</button>
