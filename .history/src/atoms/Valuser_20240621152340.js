...
function Valuser() {
  ...
  return (
    <div className='ticket-page' ref={printRef}>
          ...
          scannedData.map((data) => (
            <div key={data.id} className="card-holder" onClick={() => handleEdit(data)}>
              ...
              <div className="card-right-side">
                ...
                <p><strong className='user_details'> {data.job}</strong></p>
                <p><strong ></strong> {data.office}</p>
                <p><strong></strong> {data.simu}</p>
                <p><strong></strong> {data.password}</p>
      ...
      <Button variant="contained" onClick={handlePrint}>Print Ticket</Button>
    </div>
  );
}
